...
const LIST_COLS = 'id,title,tags,branches,sessions,commits,conversations,requires,unlocks,status,rank,owner,created_by,created,created_at,updated_at,closed_at,port,chat_names,selected_session';
